...
Brabant_LAI = pd.read_pickle(p_dssat/"brabant_LAI.pkl")
...
Brabant_SWTD = pd.read_pickle(p_dssat/"brabant_SWTD.pkl")
...
Brabant_SWTD6 = pd.read_pickle(p_dssat/"brabant_SWTD6.pkl")
...
Brabant_CWAD = pd.read_pickle(p_dssat/"brabant_CWAD.pkl")
...
Amp_VV_New=pd.read_pickle(p_s1/"Amp_VV_New.pkl")
...
Amp_VH_New=pd.read_pickle(p_s1/"Amp_VH_New.pkl")
...
Amp_CR_New=pd.read_pickle(p_s1/"Amp_CR_New.pkl")
...
pkl_filename = Path('./data/model_CR.pkl')
# ###save model###
